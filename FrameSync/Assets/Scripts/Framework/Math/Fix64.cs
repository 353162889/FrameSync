...
namespace Framework {
    ...
    public partial struct FP : IEquatable<FP>, IComparable<FP> {
        ...
        //不允许从float或decimal中转换到改值（因为会丢失精度，不同机器）
        ...
        //不允许float或double转换成FP
        //public static implicit operator FP(float value) {
        //    throw new Exception("不允许float强转成FP");
        ...
        //    throw new Exception("不允许double强转成FP");
        //    return new FP((long)(value * ONE));
        //}
        ...
        //    throw new Exception("不允许decimal强转成FP");
        //    return new FP((long)(value * ONE));
        //}
